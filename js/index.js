...
function verificarOpcion(idBoton) {
    ...
    if (idBoton === "btnexcadrill") {
        ...
        document.getElementById("idtextoinicial").className = "amarrillo";
        seleccionarOpcion();
        ...
        document.getElementById("idtextoinicial").className = "rojo";
        seleccionarOpcion();
        document.getElementById("intentos").textContent = atm;
    }
...
function resetearJuego() {
    ...
    document.getElementById("idtextoinicial").className = "negro";
